                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    <th>Monto Total:</th>
                                    <td><strong class="text-primary">S/ {{ number_format($deuda->monto_total, 2) }}</strong></td>
                                </tr>
                                <tr>
                                    <th>Monto Pagado:</th>
                                    <td><strong class="text-success">S/ {{ number_format($deuda->monto_pagado, 2) }}</strong></td>
                                </tr>
                                <tr>
                                    <th>Monto Deuda:</th>
                                    <td><strong class="text-danger">S/ {{ number_format($deuda->monto_deuda, 2) }}</strong></td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-md-6">
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    @if($deuda->cliente)
                        ...
                        <div class="mt-3">
                            <a href="{{ route('clientes.show', $deuda->cliente->id) }}" class="btn btn-outline-primary btn-sm">
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <a href="{{ route('deudas.index', ['cliente_id' => $deuda->cliente->id]) }}" class="btn btn-outline-info btn-sm btn-block">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <a href="{{ route('comprobantes.show', $deuda->venta->id) }}" class="btn btn-outline-primary btn-sm">
            ...
            <form id="formAplicarPago">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">Deuda pendiente: S/ <span id="deudaPendiente">{{ number_format($deuda->monto_deuda, 2) }}</span></small>
                    </div>
                    <div class="form-group">
...
function aplicarPago(deudaId) {
    ...
    document.getElementById('montoPago').value = {{ $deuda->monto_deuda }};
