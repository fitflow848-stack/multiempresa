...
@section('title', 'Activos Fijos / No Corrientes')

@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Gestión de Activos No Corrientes</h1>
        </div>
            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Listado de ActivosRegistrados</h6>
                        <div>
                    ...
                    <div class="card-body">
                        <!-- Filtros -->
                        <form action="{{ route('activos.index') }}" method="GET" class="row g-3 mb-4 align-items-end">
                            <div class="col-md-3">
                                <label class="form-label fw-bold small text-uppercase text-muted">Tipo de Activo</label>
                ...
                <form action="{{ route('activos.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Tipo de Activo <span class="text-danger">*</span></label>
                            <select name="tipo_activo_id" id="selectTipoActivo" class="form-control" required>
                                @foreach ($tipos as $tipo)
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nombre" class="form-control"
                                placeholder="Ej. Camioneta Toyota, Laptop Dell" required>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label>Fecha Adquisición <span class="text-danger">*</span></label>
            ...
            <div class="modal-content">
                <form id="formNuevoTipo">
                    ...
                    <div class="modal-header bg-info text-white">
                        <h5 class="modal-title">Nuevo Tipo Activo</h5>
                        <button type="button" class="close text-white" data-bs-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="nombre" id="nombreTipo" class="form-control"
                                placeholder="Ej. Vehículos" required>
                        </div>
                        <div class="form-group">
        ...
        document.addEventListener('DOMContentLoaded', function() {
                ...
                formTipo.addEventListener('submit', function(e) {
                    ...
                    fetch("{{ route('activos.storeTipo') }}", {
                        ...
                        .then(data => {
                            if (data.success) {
                                // Agregar al select
                                const select = document.getElementById('selectTipoActivo');
                                if (select) {
            ...
            document.querySelectorAll('.delete-form').forEach(form => {
                form.addEventListener('submit', function(e) {
                    if (!confirm(
                            '¿Estás seguro de eliminar este activo? esta acción afectará al balance general.'
                        )) {
                        e.preventDefault();
                    }
                });
