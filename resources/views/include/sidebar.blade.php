<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{ route('principal.index') }}" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">Wolvix</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ request()->is('comprobantes*') ? 'active' : '' }}">
            <a href="{{ route('comprobantes.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Basic">Comprobantes</div>
            </a>
        </li>
        ...
        <li class="menu-item {{ request()->is('tesoreria*') ? 'active' : '' }}">
            <a href="#" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Basic">Tesorería</div>
            </a>
        </li>
        ...
        <li class="menu-item {{ request()->is('documentos*') ? 'active' : '' }}">
            <a href="#" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Basic">Doc. Electrónico</div>
            </a>
        </li>
