                        ...
                        <tbody>
                            @foreach($cierres as $cierre)
                                <tr>
                                    ...
                                    <td>{{ optional($cierre->fecha_cierre) ? 
                                        \Carbon\Carbon::parse($cierre->fecha_cierre)->format('d/m/Y H:i') : '-' }}</td>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('cierre-caja.show', $cierre->id) }}" class="btn btn-outline-primary" title="Ver"><i class="bx bx-show"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
