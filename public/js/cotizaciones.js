                ...
                <td>
                    <div>
                        ...
                        <br><small class="text-muted">
                            ${product.presentacion || ''} ${product.concentracion || ''}
                        </small>
...
function addProductToCotizacion() {
    ...
    const productToAdd = {
        ...
        descripcion: `${currentEditingProduct.nombre} ${currentEditingProduct.presentacion || ''} ${currentEditingProduct.concentracion || ''}`.trim(),
        cantidad: cantidad,
